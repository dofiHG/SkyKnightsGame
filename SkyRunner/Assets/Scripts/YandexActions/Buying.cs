...
public class Buying : MonoBehaviour
{
    ...
    public void SuccessPurchased(string id)
    {
        ...
        if (id == "2")
        {
            ...
            for (int i = 0; i < YandexGame.savesData.openedStars.Length; i++)
                if (YandexGame.savesData.openedStars[i] == 0) { starToOpen = i; break; }
        ...
        if (id == "3")
        {
            for (int i = 0; i <= YandexGame.savesData.openedStars.Length; i++)
            {
                if (YandexGame.savesData.openedStars[i] == 0) { YandexGame.savesData.openedStars[i] = 1; break; }
            }
        }
