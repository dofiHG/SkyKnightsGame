...
public class CharacterAttack : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (_reloadTime <= 0)
        {
            ...
            else if (EventSystem.current.currentSelectedGameObject.name == "Punch" && gameObject.GetComponent<Animator>().GetBool("IsJumping") == true && !_dialoguePanel.activeInHierarchy)
                JumpAttack();
        }
